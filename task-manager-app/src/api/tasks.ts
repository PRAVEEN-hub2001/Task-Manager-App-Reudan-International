...
export const updateTask = (id: number, task: Omit<Task, "id">) => axios.put<Task>(`${API_URL}/tasks/${id}`, task, { withCredentials: true });
export const deleteTask = (id: number) => axios.delete(`${API_URL}/tasks/${id}`, { withCredentials: true });
